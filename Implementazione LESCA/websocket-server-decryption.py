...
from Lesca import lesca_decrypt, lesca_encrypt, initialization
...
async def shared_key_creation(websocket):
    ...
    #mandiamo la nostra chiave pubblica e aspettiamo di ricevere la chiave pubblica del nostro interlocutore
...
async def main():
    async with websockets.serve(lesca_connection, "localhost", 8765):
